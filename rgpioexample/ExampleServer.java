    ...
    public void start() {
        ...
        while (true) {
            try {
                ...
                Thread.sleep(3000);
                RGPIO.receiveFromDevice("192.168.0.99", "Event/HWid:1625496/Model:RELAY/Dip:2/State:Low");
                Thread.sleep(3000);
                RGPIO.receiveFromDevice("192.168.0.99", "Event/HWid:1625496/Model:RELAY/Dip:2/State:High");
